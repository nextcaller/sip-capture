...
// This is exactly the same as github.com/google/gopacket/ip4defrag, except
// that it passes its test for minimum packet length being overridden to 1.
...
func TestDefragTooSmall(t *testing.T) {
	...
	ip1 := layers.IPv4{
		...
		Id:         0xcc,
		FragOffset: 0,
		Length:     20, // Minimum fragment size -1 + header (20)
		Flags:      layers.IPv4MoreFragments,
	}
	if _, err := defrag.DefragIPv4(&ip1); err == nil {
		t.Fatal("defrag: Minimum fragment size is supposed to be 1")
	}
